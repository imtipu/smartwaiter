...
//        $movefile = move_uploaded_file($file_tmp, $target_file);
        ...
        if ($getStore->addNewCat() == true){
            $_SESSION['catMsg'] = '<div class="alert alert-success">New Category Added.</div>';
            ...
            $_SESSION['catMsg'] = '<div class="alert alert-danger">Food Add Failed</div>';
            header('location:'.$_SERVER['HTTP_REFERER']);
        }
    }
}
