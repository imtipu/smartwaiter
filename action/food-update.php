...
//        $movefile = move_uploaded_file($file_tmp, $target_file);
        ...
        if ($getStore->updateFood($_POST['food_id']) == true){
            $_SESSION['foodMsg'] = '<div class="alert alert-success">Food Updated.</div>';
            ...
            $_SESSION['foodMsg'] = '<div class="alert alert-danger">Food Update Failed</div>';
            header('location:'.$_SERVER['HTTP_REFERER']);
        }
    }
}
